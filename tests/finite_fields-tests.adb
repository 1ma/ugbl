...
package body Finite_Fields.Tests is
   ...
   begin
      ...
      AUnit.Assertions.Assert (18 = FF_Add (44, 33, 59), "J.Song App.A Ch.1 Ex 2.1");
      AUnit.Assertions.Assert (49 = FF_Add (FF_Add (17, 42, 59), 49, 59), "J.Song App.A Ch.1 Ex 2.3");
   end Test_Addition;
   ...
   begin
      --  Ex2 uses field 57, but 57 is not a prime number so I picked the closest one (59).
      AUnit.Assertions.Assert (39 = FF_Sub (9, 29, 59), "J.Song App.A Ch.1 Ex 2.2");
      AUnit.Assertions.Assert (43 = FF_Sub (FF_Sub (52, 30, 59), 38, 59), "J.Song App.A Ch.1 Ex 2.4");
   ...
   procedure Test_Multiplication (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      AUnit.Assertions.Assert (23 = FF_Mul (FF_Mul (95, 45, 97), 31, 97), "J.Song App.A Ch.1 Ex 4.1");
      AUnit.Assertions.Assert (68 = FF_Mul (FF_Mul (FF_Mul (17, 13, 97), 19, 97), 44, 97), "J.Song App.A Ch.1 Ex 4.2");
   ...
   procedure Test_Exp_And_Div (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      AUnit.Assertions.Assert (63 = FF_Mul (FF_Exp (12, 7, 97), FF_Exp (77, 49, 97), 97), "J.Song App.A Ch.1 Ex 4.3");
      AUnit.Assertions.Assert (4 = FF_Div (3, 24, 31), "J.Song App.A Ch.1 Ex 8.1");
      AUnit.Assertions.Assert (29 = FF_Exp (17, -3, 31), "J.Song App.A Ch.1 Ex 8.2");
      AUnit.Assertions.Assert (13 = FF_Mul (FF_Exp (4, -4, 31), 11, 31), "J.Song App.A Ch.1 Ex 8.3");
